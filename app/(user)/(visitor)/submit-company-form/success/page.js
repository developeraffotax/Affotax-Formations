  ...
  return (
    <>
        ...
        <div className="w-full flex flex-col justify-center items-center gap-2 relative py-36 font-poppins">
                ...
                <h3 className="mb-8 text-xl max-lg:text-center">We have received your company submission form.</h3>
        ...
        <div className="absolute right-0 top-[10%] max-lg:hidden"> <Image src={Right} width={400} height={400} alt="success-left" className="w-[150px]"/> </div>
        <div className="absolute left-0 bottom-[10%] max-lg:hidden"> <Image src={Left} width={400} height={400} alt="success-left" className="w-[150px]"/> </div>
