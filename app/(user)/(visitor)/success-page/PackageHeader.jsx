...
<section className="w-full  grid   grid-cols-[2fr_1fr_2fr_1fr_2fr_1fr_2fr] py-12 gap-2  ">
...
<div className=" flex flex-col justify-center items-center gap-4  border-b-2 pb-2    text-cyan-500 border-cyan-500"> 
