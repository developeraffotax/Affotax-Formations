      ...
      <div className="w-full flex flex-col justify-start items-start gap-2 border  ">
           ...
           <div className="w-full   ">
            ...
            <div className="w-full flex flex-col justify-start items-start gap-2   p-5     ">
              ...
              <div className="w-full"> {" "} <Controller control={control} name="locality" render={({ field }) => ( <Input {...field} size="sm" errorMessage={errors?.locality?.message} isInvalid={errors?.locality ? true : false} key="locality" classNames={{ mainWrapper: "w-full ", label: "w-[40%] text-base p-0", }} label="Street*	" labelPlacement="outside-left" type="text" /> )} /> </div>
              <div className="w-full"> {" "} <Controller control={control} name="town" render={({ field }) => ( <Input {...field} size="sm" errorMessage={errors?.town?.message} isInvalid={errors?.town ? true : false} key="town" classNames={{ mainWrapper: "w-full ", label: "w-[40%] text-base p-0", }} label="Locality	" labelPlacement="outside-left" type="text" /> )} /> </div>
              <div className="w-full"> {" "} <Controller control={control} name="county" render={({ field }) => ( <Input {...field} size="sm" errorMessage={errors?.county?.message} isInvalid={errors?.county ? true : false} key="county" classNames={{ mainWrapper: "w-full ", label: "w-[40%] text-base p-0", }} label="Town*		" labelPlacement="outside-left" type="text" /> )} /> </div>
