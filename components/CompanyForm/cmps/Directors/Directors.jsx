...
const Directors = ({ directors, setDirectors, continueBtnHandler, goBackBtnHandler }) => {
  ...
  useEffect(() => {
    ...
    if (residential_address_isSameAsService) {
      ...
      setValue( "residential_address_postcode", getValues("service_address_postcode") ); setValue( "residential_address_country", getValues("service_address_country") );
