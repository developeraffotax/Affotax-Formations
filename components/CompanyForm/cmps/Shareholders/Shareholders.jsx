      ...
      <div className="w-full flex flex-col justify-start items-start gap-0 border  ">
        ...
        <div className="w-full flex flex-col justify-start items-start gap-2       ">
          <table className="w-full  table-auto border-collapse ">
            <tbody>
              ...
              <tr className="  ">
                ...
                <div className="w-full"> {" "} <Controller defaultValue={1}   control={control}  name="num_of_shares" render={({ field }) => ( <Input {...field} onChange={(e) => field.onChange(+(e.target.value))}   size="sm" variant="bordered" errorMessage={errors?.num_of_shares?.message} isInvalid={errors?.num_of_shares ? true : false} key="num_of_shares"   type="number"  /> )} />{" "} </div>
              ...
              <tr className="  ">
                ...
                <td className="border px-5 py-2 flex justify-start items-center gap-2 ">
                <div className="w-full"> {" "} <Controller defaultValue={1}   control={control}  name="value_per_share" render={({ field }) => ( <Input {...field}    onChange={(e) => field.onChange(+(e.target.value))}   size="sm" variant="bordered" errorMessage={errors?.value_per_share?.message} isInvalid={errors?.value_per_share ? true : false} key="value_per_share"   type="number"  /> )} />{" "} </div>
...

          {
              ...
              (num > 0) && ((new Array(num)).fill('test').map((el, index) => {
