...
<ul className="flex flex-col justify-start items-start gap-2"> 
    ...
    <Link onClick={onClick} href="/service/registered-office-address" className="flex justify-start items-center hover:text-orange-500 "><MdKeyboardArrowRight className="text-xl"/> London Registered Office - £35/yr</Link>
    <Link onClick={onClick} href="/service/director-service-address" className="flex justify-start items-center hover:text-orange-500 "><MdKeyboardArrowRight className="text-xl"/>London Service Address - £24/yr</Link>
    ...
    <Link onClick={onClick} href="/service/non-uk-resident-business-address" className="flex justify-start items-center hover:text-orange-500 "><MdKeyboardArrowRight className="text-xl"/> London Business Address - £75/yr</Link>
